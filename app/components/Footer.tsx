      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        >
          ...
          <div className="flex items-center gap-3 pb-3">
            {/* <Link
              href="https://github.com/wahyudwiprstka"
              target="_blank"
              className="w-11 h-11 rounded-full flex justify-center items-center border border-slate-100 text-white hover:border-white hover:bg-white hover:text-black transition"
            >
              <svg
                role="img"
                width="30"
            ...
            <Link
              href="https://www.linkedin.com/in/i-kadek-wahyu-dwi-prastika-497313236/"
              target="_blank"
              className="w-11 h-11 rounded-full flex justify-center items-center border border-slate-100 text-white hover:border-white hover:bg-white hover:text-black transition"
            >
              <svg
            ...
            <Link
              href="https://www.instagram.com/ric.balijembrana/"
              target="_blank"
              className="w-8 h-8 rounded-full flex justify-center items-center border border-slate-100 text-white hover:border-white hover:bg-white hover:text-black transition"
            >
              <svg
                role="img"
                width="20"
            ...
            <Link
              href="https://www.facebook.com/profile.php?id=61584088953668"
              target="_blank"
              className="w-8 h-8 rounded-full flex justify-center items-center border border-slate-100 text-white hover:border-white hover:bg-white hover:text-black transition"
            >
              <svg
            ...
            <Link
              href="https://www.youtube.com/@RisingInternationalCollege"
              target="_blank"
              className="w-8 h-8 rounded-full flex justify-center items-center border border-slate-100 text-white hover:border-white hover:bg-white hover:text-black transition"
            >
              <svg
            ...
            {/* <Link
              href="https://www.tiktok.com/@wahyudwiprastikaaa"
              target="_blank"
              className="w-11 h-11 rounded-full flex justify-center items-center border border-slate-100 text-white hover:border-white hover:bg-white hover:text-black transition"
            >
              <svg
